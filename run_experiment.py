...
if __name__ == "__main__":
    ...
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
                     new_exp, data_folder, ec.BLOCK1, 0, 1200, visual=False)
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
                     new_exp, data_folder, ec.BLOCK2, 20, 1200, visual=False)
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
                     new_exp, data_folder, ec.BLOCK3, 40, 1200, visual=False)
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
                     new_exp, data_folder, ec.BLOCK4, 0, 800, visual=False)
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
                     new_exp, data_folder, ec.BLOCK5, 40, 800, visual=False)
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
                     new_exp, data_folder, ec.BLOCK6, 20, 800, visual=False)
    experiment_block(env, map_sim, hunter, prey, num_episodes, save_data,
